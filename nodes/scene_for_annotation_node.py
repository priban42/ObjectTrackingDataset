...
def get_img_from_topic(topic = '/camera/color/image_raw', format = 'bgr8'):
...
def get_corrected_cam_pose(arm, joint_offsets = np.zeros(9)):
    joint_values = arm.get_current_joint_values()
    print("joint_values:", type(joint_values))
    corrected_joint_values = np.array(joint_values) - joint_offsets
    return corrected_joint_values
